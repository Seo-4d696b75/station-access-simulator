...
exports.refreshSkillStateOne = exports.refreshSkillState = exports.disactivateSkill = exports.activateSkill = exports.isSkillActive = exports.copySkillHolder = exports.getSkill = exports.copySkillState = exports.copySkill = void 0;
var __1 = require("..");
...
function copySkillHolder(skill) {
    if (skill.type === "possess") {
        return __assign({ type: "possess" }, copySkill(skill));
    }
    return {
        type: skill.type,
    };
}
exports.copySkillHolder = copySkillHolder;
/**
...
function refreshSkillState(context, state) {
    ...
    return indices.reduce(function (next, idx) { return refreshSkillStateOne(context, next, idx); }, state);
}
