...
var SkillManager = /** @class */ (function () {
    ...
    SkillManager.prototype.load = function (data) {
        return __awaiter(this, void 0, void 0, function () {
            var list, _a, _loop_1, this_1, dataset, _i, list_1, e;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    ...
                    case 3:
                        ...
                        _loop_1 = function (e) {
                            var numbering, moduleName, type, properties, logic;
                            return __generator(this, function (_c) {
                                switch (_c.label) {
                                    case 0:
                                        ...
                                        return [4 /*yield*/, Promise.resolve().then(function () { return __importStar(require("../skill/" + moduleName + ".ts")); }).then(function (o) { return o.default; })
                                                .catch(function () {
    ...
    SkillManager.prototype.getSkill = function (numbering, level) {
        ...
        if (data) {
            ...
            if (idx < 0) {
                ...
                return {
                    type: "possess",
                    skill: __assign(__assign({}, data.skill), { level: property_1.skillLevel, name: property_1.name, state: {
                            type: "not_init",
                            data: undefined,
                        }, transitionType: data.transactionType, evaluateInPink: data.evaluateInPink, propertyReader: function (key) {
