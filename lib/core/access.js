...
function initAccessDencoState(context, f, carIndex, which) {
    var formation = (0, skill_1.refreshSkillState)(context, (0, user_1.copyUserState)(f)).formation.map(function (e, idx) {
        var s = __assign(__assign({}, e), { hpBefore: e.currentHp, hpAfter: e.currentHp, which: which, who: idx === carIndex ? which : "other", carIndex: idx, reboot: false, skillInvalidated: false, damage: undefined, accessEXP: 0 });
        return s;
    });
