...
exports.counterAttack = exports.repeatAccess = exports.calcBaseDamage = exports.getBaseDamage = exports.random = exports.hasSkillTriggered = exports.getDefense = exports.getAccessDenco = exports.getFormation = exports.copyAccessState = exports.startAccess = void 0;
...
function initAccessDencoState(context, f, carIndex, which) {
    var formation = (0, skill_1.refreshSkillState)(context, (0, user_1.copyUserState)(f)).formation.map(function (e, idx) {
...
function copyAccessDencoState(state) {
    return __assign(__assign({}, (0, denco_1.copyDencoState)(state)), { which: state.which, who: state.who, carIndex: state.carIndex, hpBefore: state.hpBefore, hpAfter: state.hpAfter, reboot: state.reboot, skillInvalidated: state.skillInvalidated, damage: state.damage ? __assign({}, state.damage) : undefined, exp: state.exp });
}
...
function completeAccess(context, config, access) {
    // このアクセスイベントの追加
    var offense = __assign(__assign({}, (0, user_1.copyUserState)(config.offense.state)), { event: __spreadArray(__spreadArray([], config.offense.state.event, true), [
            {
                type: "access",
                data: {
                    access: access,
    ...
    if (access.defense && config.defense) {
        defense = __assign(__assign({}, (0, user_1.copyUserState)(config.defense.state)), { event: __spreadArray(__spreadArray([], config.defense.state.event, true), [
                {
                    type: "access",
                    data: {
                        access: access,
...
function completeDencoAccessEXP(context, state, which) {
    ...
    (_a = side === null || side === void 0 ? void 0 : side.formation) === null || _a === void 0 ? void 0 : _a.forEach(function (d) {
        ...
        // アクセスによる経験値付与
        var exp = d.exp.access + d.exp.skill;
