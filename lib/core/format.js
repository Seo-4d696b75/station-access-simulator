...
function formatRebootDetail(result, time, width) {
    ...
    result.link.forEach(function (link) {
        ...
        var pt = formatSpace(formatPt(link.score), width - 2 - len(duration), "right");
        str += "┃" + duration + pt + "┃\n";
        str += "┠" + "─".repeat(width - 2) + "┨\n";
    });
...
function formatAccessDetail(result, which, time, width) {
    ...
    str += "┠" + "─".repeat(width - 2) + "┨\n";
    str += "┃" + formatSpace(formatPt(leftSide === null || leftSide === void 0 ? void 0 : leftSide.score), tableLeft, "left");
    str += " score";
    str += formatSpace(formatPt(rightSide.score), tableRight, "right") + "┃\n";
    str += "┠" + "─".repeat(width - 2) + "┨\n";
    str += "┃" + formatSpace(formatPt(leftSide === null || leftSide === void 0 ? void 0 : leftSide.exp), tableLeft, "left");
    str += "  exp ";
