...
var DencoManager = /** @class */ (function () {
    ...
    DencoManager.prototype.getDenco = function (context, numbering, level, link) {
        ...
        return __assign(__assign({}, status), { currentExp: 0, currentHp: status.maxHp, skillHolder: skill, film: {}, link: linkList });
    };
    ...
    DencoManager.prototype.checkLevelup = function (context, current) {
        var _this = this;
        var levelup = false;
        var formation = current.formation.map(function (state) {
            var d = (0, denco_1.copyDencoState)(state);
            var level = d.level;
            while (d.currentExp >= d.nextExp) {
                var status_2 = _this.getDencoStatus(d.numbering, level + 1);
                if (status_2) {
                    levelup = true;
                    level += 1;
                    d = __assign(__assign({}, status_2), { currentHp: status_2.maxHp, currentExp: d.currentExp - d.nextExp, film: d.film, link: d.link, skillHolder: skillManager_1.default.getSkill(d.numbering, level) });
                }
                else {
                    // これ以上のレベルアップはなし
        ...
        var next = __assign(__assign({}, (0, user_1.copyUserState)(current)), { formation: formation });
        if (levelup) {
