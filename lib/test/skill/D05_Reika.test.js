...
describe("レイカのスキル", function () {
    ...
    test("スキル状態", function () {
        ...
        var skill = (0, denco_1.getSkill)(reika);
        expect(skill.transitionType).toBe("manual");
        expect(skill.state.type).toBe("idle");
        defense = (0, skill_1.activateSkill)(context, __assign(__assign({}, defense), { carIndex: 0 }));
        reika = defense.formation[0];
        skill = (0, denco_1.getSkill)(reika);
    ...
    test("発動なし-守備側", function () {
        ...
        defense = (0, skill_1.activateSkill)(context, __assign(__assign({}, defense), { carIndex: 0 }));
        reika = defense.formation[0];
        expect((0, skill_1.isSkillActive)(reika.skillHolder)).toBe(true);
    ...
    test("発動あり-攻撃側", function () {
        ...
        var charlotte = dencoManager_1.default.getDenco(context, "6", 50, 1);
        var offense = (0, user_1.initUser)(context, "とあるマスター", [reika, seria]);
        offense = (0, skill_1.activateSkill)(context, __assign(__assign({}, offense), { carIndex: 0 }));
    ...
    test("発動あり-確率ブースト", function () {
        ...
        expect((0, skill_1.isSkillActive)(hiiru.skillHolder)).toBe(true);
        var defense = (0, user_1.initUser)(context, "とあるマスター２", [charlotte]);
        var config = {
            offense: __assign({ carIndex: 0 }, offense),
            defense: __assign({ carIndex: 0 }, defense),
    ...
    test("発動あり-編成内", function () {
        ...
        var defense = (0, user_1.initUser)(context, "とあるマスター２", [charlotte]);
        var config = {
            offense: __assign({ carIndex: 1 }, offense),
            defense: __assign({ carIndex: 0 }, defense),
            station: charlotte.link[0],
        };
        var result = (0, access_1.startAccess)(context, config);
