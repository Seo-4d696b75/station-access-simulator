...
export namespace copy {
  ...
  export const AccessUserState: (src: ReadonlyState<types.AccessUserState>) => types.AccessUserState = createCopyFunc(schema.accessUserStateSchema)
...
export namespace merge {
  ...
  export const AccessUserState: (dst: types.AccessUserState, src: ReadonlyState<types.AccessUserState>) => void = createMergeFunc(schema.accessUserStateSchema)
