...
export namespace copy {
  ...
  export const MutableProperty: (src: ReadonlyState<types.MutableProperty>) => types.MutableProperty = createCopyFunc(schema.mutablePropertySchema)
  ...
  export const AccessSkillTriggerState: (src: ReadonlyState<types.AccessSkillTriggerState>) => types.AccessSkillTriggerState = createCopyFunc(schema.accessSkillTriggerStateSchema)
...
export namespace merge {
  ...
  export const MutableProperty: (dst: types.MutableProperty, src: ReadonlyState<types.MutableProperty>) => void = createMergeFunc(schema.mutablePropertySchema)
  ...
  export const AccessSkillTriggerState: (dst: types.AccessSkillTriggerState, src: ReadonlyState<types.AccessSkillTriggerState>) => void = createMergeFunc(schema.accessSkillTriggerStateSchema)
